...
private extension CharactersTableViewController {
    ...
    func movie(for indexPath: IndexPath) -> Character? {
...
extension CharactersTableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let vc = storyboard?.instantiateViewController(withIdentifier: "detailsViewController") as? CharacterDetailsViewController {
